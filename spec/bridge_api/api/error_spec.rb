...
RSpec.describe BridgeApi::API::Error do
...
RSpec.describe BridgeApi::API::BadRequestError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::UnauthorizedError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::ForbiddenError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::NotFoundError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::ConflictError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::UnsupportedMediaTypeError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::UnprocessableEntityError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::TooManyRequestsError do
  subject { described_class }

  it { is_expected.to be < BridgeApi::API::Error }
end

RSpec.describe BridgeApi::API::InternalServerError do
  subject { described_class }
